...
- **Suwayomi Integration** — 5 dedicated Quick Actions: **Recent Manga** (History), **Manga Library**, **Manga Sources** (Browse/Search), **Manga Updates**, and **Manga Downloads**
- **Pinned Manga** — one-tap menu listing all your pinned online Suwayomi manga and local files
