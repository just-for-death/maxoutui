...
-- =============================================================================
-- Pinned Manga — colecção "Pinned Manga"
-- =============================================================================

local Manga = require("desktop_modules/module_manga")

local pinned_manga_module = RowRenderer.makeModule{
    id          = "pinned_manga",
    name        = _("Pinned Manga"),
...
local M = {}
M.sub_modules = { recent_module, new_books_module, tbr_module, pinned_manga_module }
return M
